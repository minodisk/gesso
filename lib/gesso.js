(function() {
  var AnimationFrameTicker, Bitmap, CapsStyle, Class, DisplayObject, Event, EventDispatcher, EventPhase, GradientType, Graphics, InteractiveObject, JointStyle, KeyboardEvent, Loader, Matrix, MouseEvent, Rectangle, Shape, Sprite, Stage, Stopwatch, TextField, TextFormat, TextFormatAlign, TextFormatBaseline, TextFormatFont, Timer, Vector, exports, _ELLIPSE_CUBIC_BEZIER_HANDLE, _PI, _PI_1_2, _PI_2, _RADIAN_PER_DEGREE, _SQRT2, _VERSION, _atan2, _cos, _max, _min, _requestAnimationFrame, _sin, _sqrt, _storage, _tan, __slice = Array.prototype.slice, __bind = function(fn, me) {
    return function() {
  ...
  exports.display.Graphics = Graphics = function() {
      ...
      for (_j = 0, _len2 = commands.length; _j < _len2; _j++) {
        ...
        switch (command) {
         ...
         case 1:
          ...
          break;
         case 2:
          this._context.curveTo(data[i++], data[i++], data[i++], data[i++]);
          break;
         case 3:
    ...
    Graphics.prototype._curveTo = function(x1, y1, x2, y2) {
      return this._context.curveTo(x1, y1, x2, y2);
    };
