(function() {
  var AnimationFrameTicker, Bitmap, CapsStyle, Class, DisplayObject, Event, EventDispatcher, EventPhase, GradientType, Graphics, InteractiveObject, JointStyle, KeyboardEvent, Loader, Matrix, MouseEvent, Polar, Rectangle, Shape, Sprite, Stage, Stopwatch, TextField, TextFormat, TextFormatAlign, TextFormatBaseline, TextFormatFont, Timer, Vector, exports, _DEGREE_PER_RADIAN, _ELLIPSE_CUBIC_BEZIER_HANDLE, _PI, _PI_1_2, _PI_2, _RADIAN_PER_DEGREE, _SQRT2, _VERSION, _atan2, _cos, _max, _min, _requestAnimationFrame, _sin, _sqrt, _storage, _tan, __slice = Array.prototype.slice, __bind = function(fn, me) {
    return function() {
  ...
  exports.display.Graphics = Graphics = function() {
    ...
    Graphics.prototype._execStacks = function() {
      ...
      for (i = 0, _len = _ref.length; i < _len; i++) {
        ...
        if (method === "moveTo" || method === "lineTo" || method === "curveTo" || method === "cubicCurveTo" || isDrawing) {
          drawingCounter++;
    ...
    Graphics.prototype.curveTo = function(x1, y1, x2, y2) {
      this._stacks.push({
        method: "curveTo",
    ...
    Graphics.prototype._curveTo = function(x1, y1, x2, y2) {
  ...
  exports.text.AnimationFrameTicker = AnimationFrameTicker = function() {
    ...
    AnimationFrameTicker.prototype._onAnimationFrame = function(time) {
      var handler, _fn, _i, _len, _ref, _this = this;
      this._counter++;
      _ref = this._handlers;
  ...
  exports.geom.Polar = Polar = function(_super) {
    __extends(Polar, _super);
    function Polar(distance, angle) {
      this.distance = distance != null ? distance : 0;
      this.angle = angle != null ? angle : 0;
      Polar.__super__.constructor.call(this);
      this.defineProperty("x", function() {
        return this.distance * _cos(this.angle);
      });
      this.defineProperty("y", function() {
        return this.distance * _sin(this.angle);
      });
    }
    Polar.prototype.toString = function() {
      return "(" + this.distance + ", " + this.angle * _DEGREE_PER_RADIAN + ")";
    };
    Polar.prototype.toPoint = function() {
      return new Point(this.distance * _cos(this.angle, this.distance * _sin(this.angle)));
    };
    Polar.prototype.add = function(pol) {
      this.distance += pol.distance;
      this.angle += pol.angle;
      return this;
    };
    Polar.prototype.subtract = function(pol) {
      this.distance -= pol.distance;
      this.angle -= pol.angle;
      return this;
    };
    Polar.prototype.multiple = function(num) {
      this.distance *= num;
      return this;
    };
    Polar.prototype.divide = function(num) {
      this.distance /= num;
      return this;
    };
    return Polar;
  ...
  exports.geom.Vector = Vector = function(_super) {
    ...
    Vector.polar = function(distance, angle) {
      return new Vector(distance * _cos(angle), distance * _sin(angle));
    };
    Vector.add = function(pt0, pt1) {
      return new Vector(pt0.x + pt1.x, pt0.y + pt1.y);
    };
    Vector.subtract = function(pt0, pt1) {
      return new Vector(pt0.x - pt1.x, pt0.y - pt1.y);
    };
    Vector.multiple = function(pt, num) {
      return new Vector(pt.x * num, pt.y * num);
    };
    Vector.divide = function(pt, num) {
      return new Vector(pt.x / num, pt.y / num);
    };
    ...
    function Vector(x, y) {
      this.x = x != null ? x : 0;
      this.y = y != null ? y : 0;
      Vector.__super__.constructor.call(this);
    ...
    Vector.prototype.add = function(pt) {
      this.x += pt.x;
      this.y += pt.y;
      return this;
    };
    Vector.prototype.subtract = function(pt) {
      this.x -= pt.x;
      this.y -= pt.y;
      return this;
    };
    Vector.prototype.multiple = function(num) {
      this.x *= num;
      this.y *= num;
      return this;
    };
  ...
  exports.display.DisplayObject = DisplayObject = function(_super) {
    ...
    DisplayObject.prototype._setWidth = function(value) {
      if (typeof value !== "number" || isNaN(value)) {
        throw new TypeError("DisplayObject#width(setter): value isn't Number");
      }
      this._width = value;
    ...
    DisplayObject.prototype._setHeight = function(value) {
      if (typeof value !== "number" || isNaN(value)) {
        throw new TypeError("DisplayObject#height(setter): value isn't Number");
      }
      this._height = value;
    ...
    function DisplayObject() {
      ...
      this.defineProperty("x", function() {
        ...
        if (typeof value !== "number" || isNaN(value || isNaN(value))) {
          throw new TypeError("DisplayObject#x(setter): value isn't Number");
        }
        this._x = value;
        this._requestRender(false);
      });
      this.defineProperty("y", function() {
        ...
        if (typeof value !== "number" || isNaN(value)) {
          throw new TypeError("DisplayObject#y(setter): value isn't Number");
        }
        this._y = value;
        this._requestRender(false);
      });
      this.defineProperty("alpha", function() {
        ...
        if (typeof value !== "number" || isNaN(value)) {
          throw new TypeError("DisplayObject#alpha(setter): value isn't Number");
        }
        this._alpha = value;
        this._requestRender(false);
      });
      this.defineProperty("rotation", function() {
        ...
        if (typeof value !== "number" || isNaN(value)) {
          throw new TypeError("DisplayObject#rotation(setter): value isn't Number");
        }
  ...
  exports.timers.Timer = Timer = function(_super) {
    ...
    function Timer(delay, repeatCount) {
      ...
      this.defineProperty("delay", function() {
        return this._delay;
      }, function(value) {
        var running;
      ...
      this.defineProperty("repeatCount", function() {
        return this._repeatCount;
      }, function(value) {
        var isComplete, isEndless;
        this._repeatCount = value;
        isEndless = this._repeatCount === 0;
        isComplete = this._currentCount >= this._repeatCount;
        if (!isEndless && isComplete) this.stop();
      });
      this.defineProperty("currentCount", function() {
        return this._currentCount;
      });
      this.defineProperty("running", function() {
    ...
    Timer.prototype.start = function() {
      ...
      if (!this._running && (isEndless || !isComplete)) {
        ...
        this._running = true;
        return this._intervalId = setInterval(this._onInterval, this._delay);
      }
    };
    ...
    Timer.prototype._onInterval = function() {
      ...
      if (!isEndless && isComplete) {
        this.stop();
        return this.dispatchEvent(new Event(Timer.TIMER_COMPLETE));
      }
    };
    return Timer;
  }(EventDispatcher);
  ...
  exports.display.Stage = Stage = function(_super) {
    ...
    function Stage(canvasOrWidth, height) {
      ...
      this.currentFrame = 0;
      this._targetFrameRate = this._frameRate = 30;
      setInterval(this._enterFrame, 1e3 / this._targetFrameRate);
    ...
    Stage.prototype._enterFrame = function() {
      ...
      this._frameRate = (1e4 / (time - this._time) >> 0) / 10;
      this._time = time;
