...
(function() {
  var AnimationFrameTicker, Bitmap, CapsStyle, Class, DisplayObject, Event, EventDispatcher, EventPhase, GradientType, Graphics, InteractiveObject, JointStyle, KeyboardEvent, Loader, Matrix, MouseEvent, Rectangle, Shape, Sprite, Stage, TextField, TextFormat, TextFormatAlign, TextFormatBaseline, TextFormatFont, Vector, atan2, cos, exports, sin, sqrt, _ELLIPSE_CUBIC_BEZIER_HANDLE, _PI, _PI_1_2, _PI_2, _RADIAN_PER_DEGREE, _cos, _instance, _internal, _max, _min, _requestAnimationFrame, _sin, _sqrt, _tan,
  ...
  if (this.mn.dsk == null) this.mn.dsk = {};
  ...
  exports.timers.AnimationFrameTicker = AnimationFrameTicker = (function() {
